...
async def send_email_async(to_email: str, subject: str, html_content: str):
    """Async wrapper for Brevo email sending"""
    try:
...
async def submit_contact_form(request: ContactFormRequest):
    ...
    <body style="font-family: 'Manrope', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #FBFBF9; color: #1C1917;">
        ...
        <div style="padding: 30px; background-color: #FFFFFF; border: 1px solid #E7E5E4;">
            ...
            <p>{confirm_msg}</p>
            <p style="margin-top: 20px;">In the meantime, <a href="https://www.instagram.com/sunpreetsingh_" style="color: #D6C0A6; text-decoration: underline;">follow us on Instagram</a> for daily movement inspiration.</p>
...
async def notify_me(request: NotifyMeRequest):
    ...
    <body style="font-family: 'Manrope', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #FBFBF9; color: #1C1917;">
        <div style="background-color: #1C1917; color: #FBFBF9; padding: 30px; text-align: center;">
            <h1 style="font-family: 'Playfair Display', Georgia, serif; margin: 0; font-size: 24px;">You're on the List!</h1>
        </div>
        <div style="padding: 30px; background-color: #FFFFFF; border: 1px solid #E7E5E4;">
            <p>Hi there!</p>
            <p>You've been added to the notification list for <strong>{name}</strong>.</p>
            <p>We'll send you an email as soon as it's available for purchase. Be among the first to grab yours!</p>
            <p style="margin-top: 20px;">In the meantime, <a href="https://www.instagram.com/sunpreetsingh_" style="color: #D6C0A6; text-decoration: underline;">follow us on Instagram</a> for updates and movement inspiration.</p>
            <p style="margin-top: 30px; color: #57534E; font-size: 13px;">With movement,<br><strong>Sunpreet Singh</strong><br>Movement Shala</p>
        </div>
    </body>
    </html>
    ...
    <body style="font-family: 'Manrope', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #FBFBF9; color: #1C1917;">
        <div style="background-color: #1C1917; color: #FBFBF9; padding: 30px; text-align: center;">
            <h1 style="font-family: 'Playfair Display', Georgia, serif; margin: 0; font-size: 24px;">New Product Waitlist Signup</h1>
        </div>
        <div style="padding: 30px; background-color: #FFFFFF; border: 1px solid #E7E5E4;">
            <p>Someone just signed up to be notified for <strong>{name}</strong>.</p>
            <table style="width: 100%; border-collapse: collapse; margin-top: 15px;">
                ...
                <tr>
                    ...
                    <td style="padding: 10px 0;">{doc['subscribed_at']}</td>
                </tr>
            </table>
        </div>
    </body>
    ...
    return {"success": True, "message": "You'll be notified when this product is available!"}
            ...
            <html><body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                ...
                <div style="padding: 30px; background-color: #FFFFFF;">
                    ...
                    <p style="text-align: center; margin-top: 20px;">
                        <a href="https://sunpreet-coaching-1.preview.emergentagent.com/shop/{product_id}"
